...
storiesOf('Gravity/K8s', module).add('Secrets', () => {
  const props = {
  ...
  },
  {
    ...
    resource: {
      metadata: {
        ...
        namespace: 'kube-public',
        selfLink:
          '/api/v1/namespaces/kube-node-lease/secrets/default-token-z65b6',
        ...
        annotations: {
          'kubernetes.io/service-account.name': 'default',
          'kubernetes.io/service-account.uid':
            '3981754c-75bc-11e9-ae57-0ebb30a2cfe6',
        },
        managedFields: [
          {
            manager: 'kube-controller-manager',
    ...
    resource: {
      metadata: {
        ...
        annotations: {
          'kubernetes.io/service-account.name': 'default',
          'kubernetes.io/service-account.uid':
            '3980d8fd-75bc-11e9-ae57-0ebb30a2cfe6',
        },
        managedFields: [
          {
            manager: 'kube-controller-manager',
