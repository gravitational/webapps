...
storiesOf('Gravity/K8s', module).add('Deployments', () => {
  const props = {
            ...
            containers: [
              {
                ...
                image:
                  'leader.telekube.local:5000/kubernetes-helm/tiller:v2.8.1',
              },
            ],
      ...
      status: {
        ...
        conditions: [
          ...
          },
          {
            ...
            message:
              'ReplicaSet "tiller-deploy-f6b5c5794" has successfully progressed.',
          },
        ],
      },
    },
      ...
      status: {
        ...
        conditions: [
          ...
          },
          {
            ...
            reason: 'NewReplicaSetAvailable',
            message:
              'ReplicaSet "log-collector-5746856987" has successfully progressed.',
          },
        ],
      },
    },
  ...
  },
  {
    nodeMap: {
      metadata: {
        ...
        selfLink:
          '/apis/extensions/v1beta1/namespaces/kube-system/deployments/bandwagon',
        resourceVersion: '502',
        name: 'bandwagon',
      ...
      status: {
        ...
        conditions: [
          ...
          },
          {
            ...
            reason: 'NewReplicaSetAvailable',
            message:
              'ReplicaSet "bandwagon-5998fb4dd7" has successfully progressed.',
          },
        ],
      },
    },
