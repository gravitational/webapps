...
storiesOf('Gravity/K8s', module).add('DaemonSets', () => {
  const props = {
            ...
            containers: [
              {
                ...
                terminationMessagePolicy: 'File',
                image:
                  'leader.telekube.local:5000/k8s-dns-kube-dns-amd64:1.14.10',
                args: [
              ...
              },
              {
                ...
                terminationMessagePolicy: 'File',
                image:
                  'leader.telekube.local:5000/k8s-dns-sidecar-amd64:1.14.10',
                args: [
                  '--v=2',
                  '--logtostderr',
