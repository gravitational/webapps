...
storiesOf('Gravity/K8s', module).add('Jobs', () => {
  const props = {
    onFetch: () => $.Deferred(),
    jobs,
...
const jobs = [
  {
    nodeMap: {
      metadata: {
        ...
        namespace: 'kube-system',
        selfLink:
          '/apis/batch/v1/namespaces/kube-system/jobs/site-app-post-install-f3201e',
  ...
  },
  {
    nodeMap: {
      metadata: {
        ...
        namespace: 'kube-system',
        selfLink:
          '/apis/batch/v1/namespaces/kube-system/jobs/install-telekube-c8e0a9',
  ...
  },
  {
    nodeMap: {
      metadata: {
        ...
        namespace: 'kube-system',
        selfLink:
          '/apis/batch/v1/namespaces/kube-system/jobs/tiller-app-bootstrap-f5d0b0',
  ...
  },
  {
    nodeMap: {
      metadata: {
        ...
        namespace: 'kube-system',
        selfLink:
          '/apis/batch/v1/namespaces/kube-system/jobs/monitoring-app-install-573f4f',
  ...
  },
  {
    nodeMap: {
      metadata: {
        ...
        namespace: 'kube-system',
        selfLink:
          '/apis/batch/v1/namespaces/kube-system/jobs/logging-app-bootstrap-7eaf74',
  ...
  },
  {
    nodeMap: {
      metadata: {
        ...
        namespace: 'kube-system',
        selfLink:
          '/apis/batch/v1/namespaces/kube-system/jobs/bandwagon-install-a67137',
  ...
  },
  {
    nodeMap: {
      metadata: {
        ...
        namespace: 'kube-system',
        selfLink:
          '/apis/batch/v1/namespaces/kube-system/jobs/dns-app-install-4f2ffc',
