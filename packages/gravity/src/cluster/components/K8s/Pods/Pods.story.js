...
const podInfos = [
  {
            ...
            env: [
              {
                name: 'PATH',
                value:
                  '/opt/gravity:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin',
              },
              {
                name: 'POD_IP',
                valueFrom: {
        ...
        containerStatuses: [
          {
            ...
            image: 'leader.telekube.local:5000/gravity-site:5.2.3',
            imageID:
              'docker-pullable://leader.telekube.local:5000/gravity-site@sha256:5b65b93cdb2d93f1b6bb93d9188c0f69fa3a6b605f2e149eb44082207d57e0da',
            containerID:
              'docker://14572de8f46abd1167ff0680c78b2e307d6c5f051660dc63d6b78c4201f71d48',
          },
        ],
        qosClass: 'BestEffort',
      },
    ...
    podLogUrl:
      '/web/site/demo.gravitational.io/logs?query=pod%3Agravity-site-sl9mk',
    podMonitorUrl:
      '/web/site/demo.gravitational.io/monitor/dashboard/db/pods?var-namespace=kube-system&var-podname=gravity-site-sl9mk',
    name: 'gravity-site-sl9mk',
    namespace: 'kube-system',
    ...
    containers: [
      {
        name: 'gravity-site',
        logUrl:
          '/web/site/demo.gravitational.io/logs?query=container%3Agravity-site',
        phaseText: 'running',
      },
    ],
    containerNames: ['gravity-site'],
    labelsText: [
      'app:gravity-site',
      'controller-revision-hash:2853577482',
      'pod-template-generation:1',
  ...
  },
  {
    podMap: {
      metadata: {
        ...
        selfLink:
          '/api/v1/namespaces/kube-system/pods/bandwagon-5998fb4dd7-npwn6',
        resourceVersion: '498',
        ...
        containerStatuses: [
          {
            ...
            image: 'leader.telekube.local:5000/bandwagon:5.2.3',
            imageID:
              'docker-pullable://leader.telekube.local:5000/bandwagon@sha256:9015f6c49f3afd541c131eb32f829f91cf48cf9dfe5140e23879a2f5a65b2a06',
            containerID:
              'docker://9160910e8a5a006b1e7bc6bdf87618617ec852f333e53249d34ed9b207227b72',
          },
        ],
        qosClass: 'BestEffort',
      },
    ...
    podLogUrl:
      '/web/site/demo.gravitational.io/logs?query=pod%3Abandwagon-5998fb4dd7-npwn6',
    podMonitorUrl:
      '/web/site/demo.gravitational.io/monitor/dashboard/db/pods?var-namespace=kube-system&var-podname=bandwagon-5998fb4dd7-npwn6',
    name: 'bandwagon-5998fb4dd7-npwn6',
    namespace: 'kube-system',
    podHostIp: '10.128.0.6',
    podIp: '10.244.13.4',
    containers: [
      {
        name: 'bandwagon',
        logUrl:
          '/web/site/demo.gravitational.io/logs?query=container%3Abandwagon',
        phaseText: 'running',
      },
    ],
    containerNames: ['bandwagon'],
    labelsText: ['app:bandwagon', 'pod-template-hash:1554960883'],
  ...
  },
  {
    podMap: {
      metadata: {
        ...
        selfLink:
          '/api/v1/namespaces/kube-system/pods/tiller-deploy-f6b5c5794-d6txm',
        resourceVersion: '888',
        ...
        containerStatuses: [
          {
            ...
            image: 'leader.telekube.local:5000/kubernetes-helm/tiller:v2.8.1',
            imageID:
              'docker-pullable://leader.telekube.local:5000/kubernetes-helm/tiller@sha256:f0af436a310c8c906b7f261fc9d5625596a9791f06ca36b88d556d23a0cecf4e',
            containerID:
              'docker://d8c1fd7f1720911846ac4d0d826b681d0b1a95a4f39aa54a6a2c8b38c4949b56',
          },
        ],
        qosClass: 'BestEffort',
      },
    ...
    podLogUrl:
      '/web/site/demo.gravitational.io/logs?query=pod%3Atiller-deploy-f6b5c5794-d6txm',
    podMonitorUrl:
      '/web/site/demo.gravitational.io/monitor/dashboard/db/pods?var-namespace=kube-system&var-podname=tiller-deploy-f6b5c5794-d6txm',
    name: 'tiller-deploy-f6b5c5794-d6txm',
    namespace: 'kube-system',
    podHostIp: '10.128.0.6',
    podIp: '10.244.13.13',
    ...
    containerNames: ['tiller'],
    labelsText: ['app:helm', 'name:tiller', 'pod-template-hash:926171350'],
    status: 'Running',
  ...
  },
  {
      ...
      spec: {
        ...
        containers: [
          ...
          },
          {
            ...
            terminationMessagePolicy: 'File',
            image:
              'leader.telekube.local:5000/k8s-dns-dnsmasq-nanny-amd64:1.14.10',
            args: [
              '-v=2',
              '-logtostderr',
        ...
        containerStatuses: [
          {
            ...
            image:
              'leader.telekube.local:5000/k8s-dns-dnsmasq-nanny-amd64:1.14.10',
            imageID:
              'docker-pullable://leader.telekube.local:5000/k8s-dns-dnsmasq-nanny-amd64@sha256:af9e38c7dd94ddf057154e7e4ea99ac02f7be0b40b5a46342dbeb70ecb1c03ec',
            containerID:
              'docker://6b3b1a422cf64b55043a90e7e1e0b6742480623e2ba9dc090cddcdaf88da930c',
          },
          {
            name: 'kubedns',
            state: {
            ...
            image: 'leader.telekube.local:5000/k8s-dns-kube-dns-amd64:1.14.10',
            imageID:
              'docker-pullable://leader.telekube.local:5000/k8s-dns-kube-dns-amd64@sha256:8030f3e03b7b98fa11f36027760cbe41c2ef8e167051c8e451d1399274944984',
            containerID:
              'docker://4d467c881929367f78a8a2f6fa6b08121c75bd307f015150a5b010ae90922672',
          },
          {
            name: 'sidecar',
            state: {
            ...
            image: 'leader.telekube.local:5000/k8s-dns-sidecar-amd64:1.14.10',
            imageID:
              'docker-pullable://leader.telekube.local:5000/k8s-dns-sidecar-amd64@sha256:4030e4ceb2c2aada6c949bd6036a2ce042979f5705f43d2f857c2ab348f28ad9',
            containerID:
              'docker://8f90faf5e7885b1b2ce96e471c40630c2bcf85dc1d9f777e477a4cf547ccad67',
          },
        ],
        qosClass: 'Burstable',
      },
    ...
    podLogUrl:
      '/web/site/demo.gravitational.io/logs?query=pod%3Akube-dns-xlrt2',
    podMonitorUrl:
      '/web/site/demo.gravitational.io/monitor/dashboard/db/pods?var-namespace=kube-system&var-podname=kube-dns-xlrt2',
    name: 'kube-dns-xlrt2',
    namespace: 'kube-system',
    podHostIp: '10.128.0.6',
    podIp: '10.244.13.3',
    containers: [
      {
        name: 'dnsmasq',
        logUrl:
          '/web/site/demo.gravitational.io/logs?query=container%3Adnsmasq',
        phaseText: 'running',
      },
      {
        name: 'kubedns',
        logUrl:
          '/web/site/demo.gravitational.io/logs?query=container%3Akubedns',
        phaseText: 'running',
      },
      {
        name: 'sidecar',
        logUrl:
          '/web/site/demo.gravitational.io/logs?query=container%3Asidecar',
        phaseText: 'running',
      },
    ],
    containerNames: ['kubedns', 'dnsmasq', 'sidecar'],
    labelsText: [
      'controller-revision-hash:1166559781',
      'k8s-app:kube-dns',
      'pod-template-generation:1',
  ...
  },
  {
        ...
        containerStatuses: [
          {
            ...
            image: 'leader.telekube.local:5000/log-forwarder:5.0.2',
            imageID:
              'docker-pullable://leader.telekube.local:5000/log-forwarder@sha256:b37964294055eee57155470ee220098b1a415485b16bdf48f6eff76272ec4336',
            containerID:
              'docker://3c87b9b74c0643064127498030fc644b485e4804d58dd574e0922ab85eeb356c',
          },
        ],
        qosClass: 'Burstable',
      },
    ...
    podLogUrl:
      '/web/site/demo.gravitational.io/logs?query=pod%3Alog-forwarder-jnd9j',
    podMonitorUrl:
      '/web/site/demo.gravitational.io/monitor/dashboard/db/pods?var-namespace=kube-system&var-podname=log-forwarder-jnd9j',
    name: 'log-forwarder-jnd9j',
    namespace: 'kube-system',
    podHostIp: '10.128.0.6',
    podIp: '10.244.13.6',
    containers: [
      {
        name: 'log-forwarder',
        logUrl:
          '/web/site/demo.gravitational.io/logs?query=container%3Alog-forwarder',
        phaseText: 'running',
      },
    ],
    containerNames: ['log-forwarder'],
    labelsText: [
      'name:log-forwarder',
      'controller-revision-hash:3833365929',
      'pod-template-generation:1',
  ...
  },
  {
    podMap: {
      metadata: {
        ...
        selfLink:
          '/api/v1/namespaces/kube-system/pods/log-collector-5746856987-m8gcj',
        ...
        initContainerStatuses: [
          {
            ...
            state: {
              terminated: {
                ...
                containerID:
                  'docker://fdf37fc13053aa66ffdafc5740187d202539e76b200e9139e748964389ae9b5f',
              },
            },
            lastState: {},
            ready: true,
            ...
            image: 'leader.telekube.local:5000/log-collector:5.0.2',
            imageID:
              'docker-pullable://leader.telekube.local:5000/log-collector@sha256:37833c2e430994a860ebb48b9c2ee023295b283ec4ed6f51ee198124d11de37c',
            containerID:
              'docker://fdf37fc13053aa66ffdafc5740187d202539e76b200e9139e748964389ae9b5f',
          },
        ],
        containerStatuses: [
          {
            ...
            imageID:
              'docker-pullable://leader.telekube.local:5000/log-collector@sha256:37833c2e430994a860ebb48b9c2ee023295b283ec4ed6f51ee198124d11de37c',
            containerID:
              'docker://16330617e238e853ee00fbfd9ef41e64106a763d2501aa7d681ed14380fc411e',
          },
        ],
        qosClass: 'Burstable',
      },
    ...
    podLogUrl:
      '/web/site/demo.gravitational.io/logs?query=pod%3Alog-collector-5746856987-m8gcj',
    podMonitorUrl:
      '/web/site/demo.gravitational.io/monitor/dashboard/db/pods?var-namespace=kube-system&var-podname=log-collector-5746856987-m8gcj',
    name: 'log-collector-5746856987-m8gcj',
    namespace: 'kube-system',
    podHostIp: '10.128.0.6',
    podIp: '10.244.13.2',
    containers: [
      {
        name: 'log-collector',
        logUrl:
          '/web/site/demo.gravitational.io/logs?query=container%3Alog-collector',
        phaseText: 'running',
      },
    ],
    containerNames: ['log-collector'],
    labelsText: [
      'pod-template-hash:1302412543',
      'role:log-collector',
      'version:v1',
