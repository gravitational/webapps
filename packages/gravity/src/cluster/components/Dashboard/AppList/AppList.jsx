...
export function AppList(props) {
  ...
  return (
    <Box {...rest}>
      ...
      >
        <Text typography="h4">Installed Applications</Text>
      </Flex>
      <TablePaged data={data} pageSize={pageSize}>
        <Column header={<Cell>Status</Cell>} cell={<StatusCell />} />
        <Column header={<Cell>Name</Cell>} cell={<AppNameCell />} />
        <Column
          columnKey="chartVersion"
          header={<Cell>Version</Cell>}
          cell={<TextCell />}
        />
        <Column header={<Cell>Endpoints</Cell>} cell={<EndpointCell />} />

        <Column
          columnKey="updatedText"
          header={<Cell style={alignedRight}>Updated</Cell>}
