...
export const LabelState = styled.span([
  fontWeight,
  width,
  textColor,
  margin,
...
export const StateDanger = styled(LabelState).attrs({
  kind: 'danger',
} as LabelStateProps)``;
export const StateInfo = styled(LabelState).attrs({
  kind: 'secondary',
} as LabelStateProps)``;
export const StateWarning = styled(LabelState).attrs({
  kind: 'warning',
} as LabelStateProps)``;
export const StateSuccess = styled(LabelState).attrs({
  kind: 'success',
} as LabelStateProps)``;
