...
goog.exportSymbol('proto.teleport.terminal.v1.CertExpired', null, global);
goog.exportSymbol('proto.teleport.terminal.v1.ClusterClientEvent', null, global);
goog.exportSymbol('proto.teleport.terminal.v1.ClusterClientEvent.EventCase', null, global);
goog.exportSymbol('proto.teleport.terminal.v1.ClusterServerEvent', null, global);
goog.exportSymbol('proto.teleport.terminal.v1.ClusterServerEvent.EventCase', null, global);
...
goog.exportSymbol('proto.teleport.terminal.v1.LoginSuccess', null, global);
 ...
 * @constructor
 */
proto.teleport.terminal.v1.ClusterClientEvent = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.teleport.terminal.v1.ClusterClientEvent.oneofGroups_);
};
goog.inherits(proto.teleport.terminal.v1.ClusterClientEvent, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.teleport.terminal.v1.ClusterClientEvent.displayName = 'proto.teleport.terminal.v1.ClusterClientEvent';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.teleport.terminal.v1.ClusterServerEvent = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.teleport.terminal.v1.ClusterServerEvent.oneofGroups_);
};
goog.inherits(proto.teleport.terminal.v1.ClusterServerEvent, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.teleport.terminal.v1.ClusterServerEvent.displayName = 'proto.teleport.terminal.v1.ClusterServerEvent';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.teleport.terminal.v1.LoginSuccess = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.teleport.terminal.v1.LoginSuccess, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.teleport.terminal.v1.LoginSuccess.displayName = 'proto.teleport.terminal.v1.LoginSuccess';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.teleport.terminal.v1.CertExpired = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.teleport.terminal.v1.CertExpired, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.teleport.terminal.v1.CertExpired.displayName = 'proto.teleport.terminal.v1.CertExpired';
}
 ...
 * @const
 */
proto.teleport.terminal.v1.ClusterClientEvent.oneofGroups_ = [[2]];

/**
 * @enum {number}
 */
proto.teleport.terminal.v1.ClusterClientEvent.EventCase = {
  EVENT_NOT_SET: 0,
  LOGIN_SUCCESS: 2
};

/**
 * @return {proto.teleport.terminal.v1.ClusterClientEvent.EventCase}
 */
proto.teleport.terminal.v1.ClusterClientEvent.prototype.getEventCase = function() {
  return /** @type {proto.teleport.terminal.v1.ClusterClientEvent.EventCase} */(jspb.Message.computeOneofCase(this, proto.teleport.terminal.v1.ClusterClientEvent.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.teleport.terminal.v1.ClusterClientEvent.prototype.toObject = function(opt_includeInstance) {
  return proto.teleport.terminal.v1.ClusterClientEvent.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.teleport.terminal.v1.ClusterClientEvent} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.terminal.v1.ClusterClientEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    clusterUri: jspb.Message.getFieldWithDefault(msg, 1, ""),
    loginSuccess: (f = msg.getLoginSuccess()) && proto.teleport.terminal.v1.LoginSuccess.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.teleport.terminal.v1.ClusterClientEvent}
 */
proto.teleport.terminal.v1.ClusterClientEvent.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.teleport.terminal.v1.ClusterClientEvent;
  return proto.teleport.terminal.v1.ClusterClientEvent.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.teleport.terminal.v1.ClusterClientEvent} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.teleport.terminal.v1.ClusterClientEvent}
 */
proto.teleport.terminal.v1.ClusterClientEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.teleport.terminal.v1.LoginSuccess;
      reader.readMessage(value,proto.teleport.terminal.v1.LoginSuccess.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.teleport.terminal.v1.ClusterClientEvent.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.teleport.terminal.v1.ClusterClientEvent.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.teleport.terminal.v1.ClusterClientEvent} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.terminal.v1.ClusterClientEvent.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getClusterUri();
  if (f.length > 0) {
    writer.writeString(
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.teleport.terminal.v1.LoginSuccess.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {string}
 */
proto.teleport.terminal.v1.ClusterClientEvent.prototype.getClusterUri = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.teleport.terminal.v1.ClusterClientEvent} returns this
 */
proto.teleport.terminal.v1.ClusterClientEvent.prototype.setClusterUri = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional LoginSuccess login_success = 2;
 * @return {?proto.teleport.terminal.v1.LoginSuccess}
 */
proto.teleport.terminal.v1.ClusterClientEvent.prototype.getLoginSuccess = function() {
  return /** @type{?proto.teleport.terminal.v1.LoginSuccess} */ (
    jspb.Message.getWrapperField(this, proto.teleport.terminal.v1.LoginSuccess, 2));
};


/**
 * @param {?proto.teleport.terminal.v1.LoginSuccess|undefined} value
 * @return {!proto.teleport.terminal.v1.ClusterClientEvent} returns this
*/
proto.teleport.terminal.v1.ClusterClientEvent.prototype.setLoginSuccess = function(value) {
  return jspb.Message.setOneofWrapperField(this, 2, proto.teleport.terminal.v1.ClusterClientEvent.oneofGroups_[0], value);
};
 ...
 * @return {!proto.teleport.terminal.v1.ClusterClientEvent} returns this
 */
proto.teleport.terminal.v1.ClusterClientEvent.prototype.clearLoginSuccess = function() {
 ...
 * @return {boolean}
 */
proto.teleport.terminal.v1.ClusterClientEvent.prototype.hasLoginSuccess = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @const
 */
proto.teleport.terminal.v1.ClusterServerEvent.oneofGroups_ = [[2]];

/**
 * @enum {number}
 */
proto.teleport.terminal.v1.ClusterServerEvent.EventCase = {
  EVENT_NOT_SET: 0,
  CERT_EXPIRED: 2
};

/**
 * @return {proto.teleport.terminal.v1.ClusterServerEvent.EventCase}
 */
proto.teleport.terminal.v1.ClusterServerEvent.prototype.getEventCase = function() {
  return /** @type {proto.teleport.terminal.v1.ClusterServerEvent.EventCase} */(jspb.Message.computeOneofCase(this, proto.teleport.terminal.v1.ClusterServerEvent.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.teleport.terminal.v1.ClusterServerEvent.prototype.toObject = function(opt_includeInstance) {
  return proto.teleport.terminal.v1.ClusterServerEvent.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.teleport.terminal.v1.ClusterServerEvent} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.terminal.v1.ClusterServerEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    clusterUri: jspb.Message.getFieldWithDefault(msg, 1, ""),
    certExpired: (f = msg.getCertExpired()) && proto.teleport.terminal.v1.CertExpired.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.teleport.terminal.v1.ClusterServerEvent}
 */
proto.teleport.terminal.v1.ClusterServerEvent.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.teleport.terminal.v1.ClusterServerEvent;
  return proto.teleport.terminal.v1.ClusterServerEvent.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.teleport.terminal.v1.ClusterServerEvent} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.teleport.terminal.v1.ClusterServerEvent}
 */
proto.teleport.terminal.v1.ClusterServerEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.teleport.terminal.v1.CertExpired;
      reader.readMessage(value,proto.teleport.terminal.v1.CertExpired.deserializeBinaryFromReader);
      msg.setCertExpired(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.teleport.terminal.v1.ClusterServerEvent.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.teleport.terminal.v1.ClusterServerEvent.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.teleport.terminal.v1.ClusterServerEvent} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.terminal.v1.ClusterServerEvent.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getClusterUri();
  if (f.length > 0) {
    writer.writeString(
  ...
  f = message.getCertExpired();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.teleport.terminal.v1.CertExpired.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {string}
 */
proto.teleport.terminal.v1.ClusterServerEvent.prototype.getClusterUri = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.teleport.terminal.v1.ClusterServerEvent} returns this
 */
proto.teleport.terminal.v1.ClusterServerEvent.prototype.setClusterUri = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional CertExpired cert_expired = 2;
 * @return {?proto.teleport.terminal.v1.CertExpired}
 */
proto.teleport.terminal.v1.ClusterServerEvent.prototype.getCertExpired = function() {
  return /** @type{?proto.teleport.terminal.v1.CertExpired} */ (
    jspb.Message.getWrapperField(this, proto.teleport.terminal.v1.CertExpired, 2));
};


/**
 * @param {?proto.teleport.terminal.v1.CertExpired|undefined} value
 * @return {!proto.teleport.terminal.v1.ClusterServerEvent} returns this
*/
proto.teleport.terminal.v1.ClusterServerEvent.prototype.setCertExpired = function(value) {
  return jspb.Message.setOneofWrapperField(this, 2, proto.teleport.terminal.v1.ClusterServerEvent.oneofGroups_[0], value);
};
 ...
 * @return {!proto.teleport.terminal.v1.ClusterServerEvent} returns this
 */
proto.teleport.terminal.v1.ClusterServerEvent.prototype.clearCertExpired = function() {
  return this.setCertExpired(undefined);
};
 ...
 * @return {boolean}
 */
proto.teleport.terminal.v1.ClusterServerEvent.prototype.hasCertExpired = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {!Object}
 */
proto.teleport.terminal.v1.LoginSuccess.prototype.toObject = function(opt_includeInstance) {
  return proto.teleport.terminal.v1.LoginSuccess.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.teleport.terminal.v1.LoginSuccess} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.terminal.v1.LoginSuccess.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.teleport.terminal.v1.LoginSuccess}
 */
proto.teleport.terminal.v1.LoginSuccess.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.teleport.terminal.v1.LoginSuccess;
  return proto.teleport.terminal.v1.LoginSuccess.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.teleport.terminal.v1.LoginSuccess} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.teleport.terminal.v1.LoginSuccess}
 */
proto.teleport.terminal.v1.LoginSuccess.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.teleport.terminal.v1.LoginSuccess.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.teleport.terminal.v1.LoginSuccess.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.teleport.terminal.v1.LoginSuccess} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.terminal.v1.LoginSuccess.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @return {!Object}
 */
proto.teleport.terminal.v1.CertExpired.prototype.toObject = function(opt_includeInstance) {
  return proto.teleport.terminal.v1.CertExpired.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.teleport.terminal.v1.CertExpired} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.terminal.v1.CertExpired.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.teleport.terminal.v1.CertExpired}
 */
proto.teleport.terminal.v1.CertExpired.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.teleport.terminal.v1.CertExpired;
  return proto.teleport.terminal.v1.CertExpired.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.teleport.terminal.v1.CertExpired} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.teleport.terminal.v1.CertExpired}
 */
proto.teleport.terminal.v1.CertExpired.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.teleport.terminal.v1.CertExpired.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.teleport.terminal.v1.CertExpired.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.teleport.terminal.v1.CertExpired} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.terminal.v1.CertExpired.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
