...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.teleport.terminal.v1.Gateway.displayName =
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.teleport.terminal.v1.Gateway.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.teleport.terminal.v1.Gateway.toObject(
      opt_includeInstance,
      this
    );
  };
   ...
   */
  proto.teleport.terminal.v1.Gateway.toObject = function (
    includeInstance,
    msg
  ) {
    var f,
...
proto.teleport.terminal.v1.Gateway.deserializeBinary = function (bytes) {
  ...
  return proto.teleport.terminal.v1.Gateway.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.teleport.terminal.v1.Gateway}
 */
proto.teleport.terminal.v1.Gateway.deserializeBinaryFromReader = function (
  msg,
  reader
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.teleport.terminal.v1.Gateway.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
 ...
 * @return {!proto.teleport.terminal.v1.Gateway} returns this
 */
proto.teleport.terminal.v1.Gateway.prototype.setLocalAddress = function (
  value
) {
 ...
 * @return {string}
 */
proto.teleport.terminal.v1.Gateway.prototype.getTargetSubresourceName =
  function () {
    return /** @type {string} */ (
 ...
 * @return {!proto.teleport.terminal.v1.Gateway} returns this
 */
proto.teleport.terminal.v1.Gateway.prototype.setTargetSubresourceName =
  function (value) {
