...
interface IPtyHostService_ICreatePtyProcess
  extends grpc.MethodDefinition<
    ptyHostService_pb.PtyCreate,
    ptyHostService_pb.PtyId
  > {
...
interface IPtyHostService_IExchangeEvents
  extends grpc.MethodDefinition<
    ptyHostService_pb.PtyClientEvent,
    ptyHostService_pb.PtyServerEvent
  > {
...
export interface IPtyHostClient {
  createPtyProcess(
    request: ptyHostService_pb.PtyCreate,
    callback: (
      error: grpc.ServiceError | null,
      response: ptyHostService_pb.PtyId
    ) => void
  ...
  >;
  getCwd(
    request: ptyHostService_pb.PtyId,
    callback: (
      error: grpc.ServiceError | null,
      response: ptyHostService_pb.PtyCwd
    ) => void
  ): grpc.ClientUnaryCall;
  getCwd(
    request: ptyHostService_pb.PtyId,
