...
function serialize_PtyClientEvent(arg) {
  if (!(arg instanceof v1_ptyHostService_pb.PtyClientEvent)) {
...
function serialize_PtyCreate(arg) {
  if (!(arg instanceof v1_ptyHostService_pb.PtyCreate)) {
...
function serialize_PtyCwd(arg) {
  if (!(arg instanceof v1_ptyHostService_pb.PtyCwd)) {
...
function serialize_PtyId(arg) {
  if (!(arg instanceof v1_ptyHostService_pb.PtyId)) {
...
function serialize_PtyServerEvent(arg) {
  if (!(arg instanceof v1_ptyHostService_pb.PtyServerEvent)) {
...
var PtyHostService = exports.PtyHostService = {
  createPtyProcess: {
    ...
    requestType: v1_ptyHostService_pb.PtyCreate,
    responseType: v1_ptyHostService_pb.PtyId,
  ...
  exchangeEvents: {
    ...
    requestStream: true,
    responseStream: true,
    requestType: v1_ptyHostService_pb.PtyClientEvent,
    responseType: v1_ptyHostService_pb.PtyServerEvent,
  ...
  getCwd: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: v1_ptyHostService_pb.PtyId,
    responseType: v1_ptyHostService_pb.PtyCwd,
