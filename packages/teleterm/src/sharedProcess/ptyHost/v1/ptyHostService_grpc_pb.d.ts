...
interface IPtyHostService_ICreatePtyProcess
  extends grpc.MethodDefinition<
    v1_ptyHostService_pb.PtyCreate,
    v1_ptyHostService_pb.PtyId
  > {
...
interface IPtyHostService_IExchangeEvents
  extends grpc.MethodDefinition<
    v1_ptyHostService_pb.PtyClientEvent,
    v1_ptyHostService_pb.PtyServerEvent
  > {
...
interface IPtyHostService_IGetCwd
  extends grpc.MethodDefinition<
    v1_ptyHostService_pb.PtyId,
    v1_ptyHostService_pb.PtyCwd
  > {
  path: '/PtyHost/GetCwd';
  requestStream: false;
  responseStream: false;
...
export interface IPtyHostClient {
  createPtyProcess(
    request: v1_ptyHostService_pb.PtyCreate,
    callback: (
      error: grpc.ServiceError | null,
      response: v1_ptyHostService_pb.PtyId
    ) => void
  ...
  >;
  getCwd(
    request: v1_ptyHostService_pb.PtyId,
    callback: (
      error: grpc.ServiceError | null,
      response: v1_ptyHostService_pb.PtyCwd
    ) => void
  ): grpc.ClientUnaryCall;
  getCwd(
    request: v1_ptyHostService_pb.PtyId,
