...
import shieldCheck from 'design/assets/images/shield-check.png';

export default function RegisterSuccess({ redirect }: { redirect(): void }) {
  return (
    <Card
      width="540px"
      p={6}
      ...
      textAlign="center"
    >
      <Text typography="h3" color="text" mb={3}>
        Registration Successful
      </Text>
      <Flex justifyContent="center" mb={3}>
        <Image src={shieldCheck} width="200px" />
      </Flex>
