...
export default class Codec {
  ...
  // https://www.measurethat.net/Benchmarks/Show/10470/0/stringfromcharcode-btoa-vs-base64arraybuffer-function-f#latest_results_block
  // https://gist.github.com/jonleighton/958841
  toBase64V2(buffer: ArrayBuffer) {
    var base64 = '';
    var encodings =
  ...
  toBase64ImageV2(buffer: ArrayBuffer): HTMLImageElement {
    const image = new Image();
    image.src = `data:image/png;base64,${this.toBase64V2(
  ...
  decodePng(buffer: ArrayBuffer): HTMLImageElement {
    return this.toBase64ImageV2(buffer);
  }
}
