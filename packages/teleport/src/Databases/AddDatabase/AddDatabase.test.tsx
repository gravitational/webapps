...
describe('correct database add command generated with given input', () => {
  test.each`
    ...
    ${'cloud sql mysql'}      | ${'teleport db configure create --token=[generated-join-token] --auth-server=localhost:443 --name=[db-name] --protocol=mysql --uri=[uri] -o file --ca-cert=[instance-ca-filepath] --gcp-project-id=[project-id] --gcp-instance-id=[instance-id]'}
    ...
    ${'cloud sql postgres'}   | ${'teleport db configure create --token=[generated-join-token] --auth-server=localhost:443 --name=[db-name] --protocol=postgres --uri=[uri] -o file --ca-cert=[instance-ca-filepath] --gcp-project-id=[project-id] --gcp-instance-id=[instance-id]'}
