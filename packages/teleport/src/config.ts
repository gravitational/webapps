...
const cfg = {
  ...
  routes: {
    ...
    desktopPlayer: '/web/cluster/:clusterId/desktopSession/:sid',
    users: '/web/users',
  ...
  api: {
    ...
    desktopsWsPlaybackPOCPath:
      'wss://:fqdm/v1/webapi/sites/:clusterId/desktops/playbacktest/:sid?access_token=:token',
