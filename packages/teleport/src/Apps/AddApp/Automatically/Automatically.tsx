      ...
      {({ validator }) => (
        <>
          <DialogContent minHeight="254px" flex="0 0 auto">
            ...
            {!cmd && (
              <Text mb="3">
                Teleport can automatically setup application access. Provide
                the name and URL of your application to generate our
                auto-installer script. This script will install the Teleport
                node service and provide secure access to your application.
              </Text>
            )}
